...
| 9 | Simulated users | **Not started; scope decided 2026-08-20** — ships trimmed. Oracle self-test, generator, actors, shadow model, checker, committed seeds. The shrinker and two of six nemesis classes are deferred, with re-entry criteria in DECISIONS 9.1 and departure 9 in the README |
