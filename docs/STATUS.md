...
| 9 | Simulated users | **In progress, trimmed.** Deliverable (1) landed: the oracle self-test and the six invariants it grades, in `harness/sim/`. Generator, actors and checker next. Shrinker and two of six nemesis classes deferred — departure 9, DECISIONS 9.1 |
