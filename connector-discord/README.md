...
Reference connector for a chat platform.

> **Status: skeleton.** Content arrives in Phase 6. This README describes what the
...
Standalone daemon in a JVM we control, so nothing constrains it downward.
